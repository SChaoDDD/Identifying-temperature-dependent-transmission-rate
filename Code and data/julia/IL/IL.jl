...
Random.seed!(14);
const SAVE_PATH = "C:/Users/XLYC/Desktop/流感代码修改/python/IL/"

# ============================================================
# 数据准备
# ============================================================
source_data = DataFrame(CSV.File("C:/Users/XLYC/Desktop/流感代码修改/julia/IL/ILEMA.csv"))
n = 0
m = 312
...
u0 = Float32[N-174-612, 174, 612, 0, 612]
tspan = (0.0, 311.0)
